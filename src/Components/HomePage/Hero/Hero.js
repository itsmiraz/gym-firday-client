  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 p-3 md:p-20">
        <h1 className="text-[20px] md:text-[108px] md:leading-[110px] text-white font-medium">
          Make Every <br />
          Friday a GymFriday!
        </h1>
        <p className="text-[#CBCBCB] my-2 md:my-4 text-xs md:text-lg md:leading-[24px] font-normal mb-4 md:mb-10">
