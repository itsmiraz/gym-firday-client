...
export default function Footer() {
  return (
    <div className="bg-[#000921] grid grid-cols-1 gap-10 md:grid-cols-5 p-10 pt-10">
      ...
      <div>
        <h1 className="text-xl col-span-5 md:col-span-1 font-semibold text-white">Social</h1>
        <div></div>
      </div>
    </div>
  );
